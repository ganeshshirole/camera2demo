...
public class Camera2VideoFragment extends Fragment
    ...
    private static final long VIDEO_DURATION = 30 * 1000;
     ...
     * Button to record video
     */
    private ImageButton mButtonVideoList;
...
//                return size;
//            }
//            if (size.getWidth() == size.getHeight() * 16 / 9 && size.getWidth() <= 3840) {
//                return size;
//            }

            if (size.getWidth() == size.getHeight() * 16 / 9 && size.getWidth() <= 2912) {
                return size;
            }
        }
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.video) {
            ...
            navController.navigate(R.id.action_camera2_video_fragment_to_video_list_fragment);
        }
    }

    private void startTimer() {
        mTextField.setVisibility(View.VISIBLE);
        // Create a CountDownTimer to update the timerTextView
        countDownTimer = new CountDownTimer(VIDEO_DURATION, 1000) {
            @Override
            public void onTick(long millisUntilFinished) {
                long secondsRemaining = millisUntilFinished / 1000;
                mTextField.setText(String.valueOf(secondsRemaining));
            }

            @Override
            public void onFinish() {
                mTextField.setText("0");
                stopRecordingVideo(); // Implement this method to stop recording
            }
        };
    ...
    private void startRecordingVideo() {
        ...
        try {
            ...
            startTimer();
            mButtonVideoList.setVisibility(View.GONE);
...
//        analyzeImageWithMLKit(inputImage);
    ...
    private void stopRecordingVideo() {
        try {
            ...
            mButtonVideoList.setVisibility(View.VISIBLE);

            mIsRecordingVideo = false;
            mButtonVideo.setPressed(false);
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(requireActivity())
                    ...
                    .setPositiveButton(android.R.string.ok, (dialog, which) -> {
                        if (parent != null) {
                            ActivityCompat.requestPermissions(parent.requireActivity(), VIDEO_PERMISSIONS,
