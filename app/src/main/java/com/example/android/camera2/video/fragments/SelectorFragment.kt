...
import com.example.android.camera2.video.EncoderWrapper.Companion.VIDEO_CODEC_ID_H264
...
//                        )
                        ...
                        navController.navigate(
                            SelectorFragmentDirections.actionSelectorFragmentToPreviewFragment(
                                item.cameraId, item.size.width, item.size.height, item.fps,
                                1, 1, true, true, VIDEO_CODEC_ID_H264, false, false, 0
                            )
                        )
                    } else {
                        navController.navigate(
                            SelectorFragmentDirections.actionSelectorFragmentToPreviewFragment(
                                item.cameraId, item.size.width, item.size.height, item.fps,
                                1, 1, false, true, VIDEO_CODEC_ID_H264, false, false, 0
                            )
                        )
                    }
                }
